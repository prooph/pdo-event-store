...
final class MySQLEventStoreProjectionFactory implements RequiresConfig, RequiresConfigId, ProvidesDefaultOptions, RequiresMandatoryOptions
{
     ...
     */
    public static function __callStatic(string $name, array $arguments): MySQLEventStoreProjection
    {
