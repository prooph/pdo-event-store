...
use Prooph\EventStore\PDO\Projection\AbstractPDOReadModelProjection;

abstract class AbstractPDOEventStoreReadModelProjectionFactory extends AbstractProjectionFactory
{
    abstract protected function getInstanceClassName(): string;

    public function __invoke(ContainerInterface $container): AbstractPDOReadModelProjection
    {
