...
use ProophTest\EventStore\Projection\AbstractEventStoreQueryTestCase;
use Prophecy\PhpUnit\ProphecyTrait;

abstract class AbstractPdoEventStoreQueryCustomSchemaTestCase extends AbstractEventStoreQueryTestCase
{
    use ProphecyTrait;
